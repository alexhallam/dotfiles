...
sudo apt-get install curl neovim tmux mpd ncmpcpp make alsa-utils r-base-dev r-cran-tidyverse feh build-essential libx11-dev libxft-dev libxinerama-dev xorg-dev sxhkd mpv pavucontrol
