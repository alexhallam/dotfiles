...
sudo apt-get install curl neovim tmux mpv ncmpcpp make alsa-utils r-base-dev r-cran-tidyverse python3-pip neofetch tree feh build-essential libx11-dev libxft-dev libxinerama-dev xorg-dev sxhkd mpv pavucontrol
